...
DEFAULT_CONCEPTS: tuple[ConceptDefinition, ...] = (
    ...
    ConceptDefinition("current_assets", StatementKind.BALANCE, ("AssetsCurrent",), ("USD",), instant=True),
    ConceptDefinition("current_liabilities", StatementKind.BALANCE, ("LiabilitiesCurrent",), ("USD",), instant=True),
