...
AXIOM v0.5 adds typed industry edges, company exposures, graph snapshots, path queries, and public JSON export.

```bash
axiom industry --company-id company:US-NVDA
axiom industry --company-id company:US-NVDA --source-id company:KR-000660 --target-id company:US-NVDA
```
